 ...
 */
public class MoviesFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    private static final String News_URL = "http://content.guardianapis.com/search?q=movies&api-key=3acf648e-60c0-49e6-8a7b-269b2c63ddac";
